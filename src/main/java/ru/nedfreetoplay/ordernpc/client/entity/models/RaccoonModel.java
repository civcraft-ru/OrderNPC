package ru.nedfreetoplay.ordernpc.client.entity.models;
...
public class RaccoonModel extends AnimatedGeoModel<RaccoonEntity> {
    ...
    public Identifier getModelLocation(RaccoonEntity object) {
        return new Identifier(OrderNPC.MOD_ID, "geo/raccoon.geo.json");
    }
    ...
    public Identifier getAnimationFileLocation(RaccoonEntity animatable) {
        return new Identifier(OrderNPC.MOD_ID, "animations/raccoon.animation.json");
    }
